...
@Entity
@Table(name = "rc_portaria",schema = "recebimento")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class CarregamentoEntity {
    ...
    @ManyToOne(cascade = CascadeType.ALL) // Ajuda a tratar objetos que já existem ou estão sendo criados
    @JoinColumn(name = "resumo_carga_id")
    private ResumoCargaEntity resumoCargaEntity;
